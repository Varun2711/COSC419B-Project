...
dataset = {'SoccerNet':
                {'root_dir': './data/SoccerNet',
                 ...
                 'test': {
                        ...
                        'raw_legible_result': 'raw_legible_efficientnet.json',
                 ...
                 'legibility_model': "experiments/legibility_efficientnet_20250331-191829.pth",
                 'legibility_model_arch': "efficientnet",
